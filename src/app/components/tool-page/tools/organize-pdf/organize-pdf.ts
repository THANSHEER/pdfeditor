      ...
      <div class="content-area">
        ...
        @if (!pdfState && !isLoading) {
          ...
          >
            ...
            <p class="upload-hint">
              Drag & drop pages to rearrange them · Processed in your browser
            </p>
          </div>
        }
        ...
        @if (pdfState && !isLoading) {
          <div class="settings-panel">
            ...
            >
              Drag pages by the
              <strong style="color:var(--text-main)">⠿ handle</strong> that
              appears on hover to reorder them. When satisfied with the order,
              click
              <strong style="color:var(--text-main)">Save Order</strong> to
