    ...
    <div class="page-shell">
      ...
      <div class="top-bar">
        ...
        <div class="top-bar-right">
          <button
            class="process-btn"
            [disabled]="!pdfState || isProcessing || !hasRotations"
            (click)="process()"
            type="button"
          >
            @if (!isProcessing) {
      ...
      <div class="content-area">
        ...
        @if (!pdfState && !isLoading) {
          ...
          >
            ...
            <p class="upload-hint">
              Rotate individual pages or all at once · Processed in your browser
            </p>
          </div>
        }
        ...
        @if (pdfState && !isLoading) {
          <div class="settings-panel">
            ...
            >
              ...
              <strong style="color:var(--text-main)">Rotate All</strong> buttons
              in the toolbar to rotate all pages at once. The thumbnail preview
              updates in real-time. Rotation badges show the applied angle.
            </p>
          </div>
        }
