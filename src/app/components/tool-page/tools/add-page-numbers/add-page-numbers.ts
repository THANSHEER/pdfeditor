...
import { AddPageNumbersService, PageNumberOptions, PageNumberPosition } from '../../../../services/tools/add-page-numbers';

@Component({
  selector: 'app-add-page-numbers',
  standalone: true,
  imports: [CommonModule, FormsModule, ToolPageComponent],
  templateUrl: './add-page-numbers.html',
  styleUrl: './add-page-numbers.css',
})
