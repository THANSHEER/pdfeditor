    ...
    <div class="page-shell">
      ...
      <div class="top-bar">
          ...
          <div class="tool-badge">
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M19.686 8.314a12.501 12.501 0 0 1 1.356 10.225 1 1 0 0 1-1.751-.119 22 22 0 0 0-3.394-6.319"
                />
              </svg>
            </div>
        ...
        <div class="top-bar-right">
          <button
            class="process-btn"
            [disabled]="!pdfState || isProcessing || selectedCount === 0"
            (click)="process()"
            type="button"
          >
            @if (!isProcessing) {
      ...
      <div class="content-area">
        ...
        @if (!pdfState && !isLoading) {
          ...
          >
            ...
            <p class="upload-hint">
              Select one or more pages to extract · Processed in your browser
            </p>
          </div>
        }
          ...
          <div class="settings-panel">
            ...
            <div class="settings-row">
              ...
              <input
                ...
                min="1"
                [max]="pdfState.totalPages"
                placeholder="{{ pdfState.totalPages }}"
              />
              <button class="change-btn" (click)="applyRange()" type="button">
                Select Range
              </button>
            </div>
          </div>
