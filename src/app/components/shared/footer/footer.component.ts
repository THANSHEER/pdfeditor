...
@Component({
  ...
  template: `
    <footer
      class="border-t border-main bg-surface transition-colors duration-500"
      ...
      <div class="max-w-7xl mx-auto px-6 py-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div class="space-y-6">
            <a
              routerLink="/"
              class="flex items-center gap-3 no-underline hover:scale-105 transition-all duration-300 w-fit group"
            >
              <div class="relative flex items-center justify-center">
                <div
                  class="absolute inset-0 rounded-lg bg-gradient-to-br from-indigo-500 via-blue-500 to-violet-600 blur-lg opacity-30 group-hover:opacity-50 transition-opacity animate-pulse"
                ></div>
                <div
              ...
              <span class="font-black text-xl -tracking-wider text-main"
                >PDF Editor</span
              >
            </a>
            <p class="text-sm text-muted leading-relaxed font-medium">
              Fast, private, and browser-based PDF manipulation tools for your
              everyday document needs.
            </p>
            <!-- Social Links -->
          ...
          <div class="space-y-4">
            <h5
              class="text-xs font-black uppercase tracking-[0.2em] text-main border-b-2 border-indigo-500 pb-2 w-fit"
            >
              Quick Links
            </h5>
            <ul class="space-y-3">
              <li>
                <a
                  routerLink="/"
                  class="text-sm text-muted hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-300 font-semibold flex items-center gap-2"
                >
          ...
          <div class="space-y-4">
            <h5
              class="text-xs font-black uppercase tracking-[0.2em] text-main border-b-2 border-violet-500 pb-2 w-fit"
            >
              Resources
            </h5>
            <ul class="space-y-3">
              ...
              <li>
                <a
                  href="https://github.com/geekstashdev/pdfeditor/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="text-sm text-muted hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300 font-semibold flex items-center gap-2"
                >
          ...
          <div class="space-y-4">
            <h5
              class="text-xs font-black uppercase tracking-[0.2em] text-main border-b-2 border-amber-500 pb-2 w-fit"
            >
              Legal
            </h5>
            <div class="space-y-3">
        ...
        <!-- Divider -->
        <div
          class="mt-12 h-px bg-gradient-to-r from-transparent via-main to-transparent"
        ...
        >
          <p
            class="text-xs font-bold uppercase tracking-widest text-muted opacity-70"
          >
