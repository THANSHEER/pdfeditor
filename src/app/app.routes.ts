...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import("./components/tool-page/tools/protect-pdf/protect-pdf.component").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("./components/tool-page/tools/unlock-pdf/unlock-pdf.component").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./components/tool-page/tools/redact-pdf/redact-pdf.component').then(
  ...
  },
  {
    path: 'tools/sign-pdf',
    loadComponent: () =>
      import('./components/tool-page/tools/sign-pdf/sign-pdf.component').then(
